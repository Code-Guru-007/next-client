...
const _dataGrid = [...Array(20)].map((_, index) => {
  ...
  return {
    id: _mock.id(index) || "id",
    status,
    email: _mock.email(index) || "",
    name: _mock.fullName(index) || "",
    age: _mock.number.age(index) || 8,
    lastLogin: _mock.time(index) || 9,
    isAdmin: _mock.boolean(index) || false,
    lastName: _mock.lastName(index) || "",
    rating: _mock.number.rating(index) || 4,
    firstName: _mock.firstName(index) || "",
    performance: _mock.number.percent(index) || 9,
  };
});
