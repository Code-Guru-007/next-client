...
// redux
import { useDispatch, useSelector } from "minimal/redux/store";
import {
  createEvent,
  updateEvent,
  deleteEvent,
} from "minimal/redux/slices/calendar";
// hooks
import { useResponsive } from "minimal/hooks/use-responsive";
// _mock
import { CALENDAR_COLOR_OPTIONS } from "minimal/_mock/_calendar";
// types
import { ICalendarEvent, ICalendarView } from "minimal/types/calendar";
