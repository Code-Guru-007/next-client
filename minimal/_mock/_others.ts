...
export const _notifications = [...Array(9)].map((_, index) => ({
  ...
  isUnRead: _mock.boolean(index) || false,
...
export const _mapContact = [
  {
    ...
    phoneNumber: _mock.phoneNumber(1) || "99",
  },
  {
    latlng: [-12.5, 18.5],
    address: _mock.fullAddress(2) || "",
    phoneNumber: _mock.phoneNumber(2) || "99",
  },
];
...
export const _homePlans = [...Array(3)].map((_, index) => ({
  license: ["Standard", "Standard Plus", "Extended"][index] || "Standard",
...
export const _testimonials = [
  {
    ...
    ratingNumber: _mock.number.rating(1) || 0,
  ...
  },
  {
    ...
    ratingNumber: _mock.number.rating(2) || 0,
  ...
  },
  {
    ...
    ratingNumber: _mock.number.rating(3) || 0,
  ...
  },
  {
    ...
    ratingNumber: _mock.number.rating(4) || 0,
  ...
  },
  {
    ...
    ratingNumber: _mock.number.rating(5) || 0,
  ...
  },
  {
    ...
    ratingNumber: _mock.number.rating(6) || 0,
