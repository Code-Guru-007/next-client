...
export interface CmsMenuProductProps {
  tableSelectedLocale?: Locale;
  openEditDialog: boolean;
  setOpenEditDialog: (val: boolean) => void;
}

const CmsMenuProduct: FC<CmsMenuProductProps> = function (props) {
  ...
  const { data, mutate } = useOrgCmsPageMenu(
    ...
    },
    {
      ...
      PAGE_TYPE_: PageType.PRODUCTDETAIL,
    }
  );
