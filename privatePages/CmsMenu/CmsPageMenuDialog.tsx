...
interface CmsPageMenuDialogProps {
  ...
  values?: OrgCmsMenuFormInput;
}

const CmsPageMenuDialog: FC<CmsPageMenuDialogProps> = function (props) {
  const {
    onSubmit,
    loading,
    open,
...
export default CmsPageMenuDialog;
