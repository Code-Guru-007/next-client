...
export const DIALOG = "SmsTemplateInfoHistoryDialog";
...
export interface SmsTemplateInfoHistoryDialogProps {
  targetId: string;
...
const SmsTemplateInfoHistoryDialog: FC<SmsTemplateInfoHistoryDialogProps> =
  function (props) {
...
export default SmsTemplateInfoHistoryDialog;
