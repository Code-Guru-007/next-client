...
export const DIALOG = "BulletinInfoHistoryDialog";
...
export interface BulletinInfoHistoryDialogProps {
  targetId: string;
...
const BulletinInfoHistoryDialog: FC<BulletinInfoHistoryDialogProps> = function (
  props
) {
...
export default BulletinInfoHistoryDialog;
