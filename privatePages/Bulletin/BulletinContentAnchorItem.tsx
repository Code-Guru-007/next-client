...
export interface BulletinContentAnchorItemProps {
  data: Data;
}

const BulletinContentAnchorItem: FC<BulletinContentAnchorItemProps> = (
  props
) => {
  const { data } = props;
...
export default BulletinContentAnchorItem;
