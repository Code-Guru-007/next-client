...
import { FeatureEditFormInput, OrganizationMediaField } from "interfaces/form";
...
export const FORM = "FeatureEditForm";

export interface FeatureEditFormProps {
  onSubmit: (
    values: FeatureEditFormInput,
...
const FeatureEditForm: FC<FeatureEditFormProps> = function (props) {
  ...
  const methods = useForm<FeatureEditFormInput>({
    defaultValues: {
