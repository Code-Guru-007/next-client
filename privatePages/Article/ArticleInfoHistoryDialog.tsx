...
export const DIALOG = "ArticleInfoHistoryDialog";
...
export interface ArticleInfoHistoryDialogProps {
  targetId: string;
...
const ArticleInfoHistoryDialog: FC<ArticleInfoHistoryDialogProps> = function (
  props
) {
  ...
  return (
    ...
    >
      <DialogTitle onClickClose={closeDialog}>
        {wordLibrary?.["article information record"] ?? "文章資訊紀錄"}
      </DialogTitle>
...
export default ArticleInfoHistoryDialog;
