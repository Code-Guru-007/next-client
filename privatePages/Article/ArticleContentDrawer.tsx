...
import AnchorItem, { Data } from "./ArticleContentAnchorItem";

export interface ArticleContentDrawerProps {
  isOpen?: boolean;
  onClickAway?: () => void;
...
const ArticleContentDrawer: FC<ArticleContentDrawerProps> = (props) => {
...
export default ArticleContentDrawer;
