...
import AnchorItem, { Data } from "./EventContentAnchorItem";

export interface EventContentDrawerProps {
  isOpen?: boolean;
  onClickAway?: () => void;
  contentRef?: React.RefObject<HTMLDivElement>;
}

const EventContentDrawer: FC<EventContentDrawerProps> = (props) => {
...
export default EventContentDrawer;
