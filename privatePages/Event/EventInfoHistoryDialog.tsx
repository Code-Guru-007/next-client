...
export const DIALOG = "EventInfoHistoryDialog";
...
export interface EventInfoHistoryDialogProps {
  targetId: string;
...
const EventInfoHistoryDialog: FC<EventInfoHistoryDialogProps> = function (
  props
) {
...
export default EventInfoHistoryDialog;
