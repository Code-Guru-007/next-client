...
import AnchorItem, { Data } from "./CrmPartnerAnchorItem";
...
export interface CrmPartnerContentDrawerProps {
  isOpen?: boolean;
  onClickAway?: () => void;
...
const CrmPartnerContentDrawer: FC<CrmPartnerContentDrawerProps> = (props) => {
...
export default CrmPartnerContentDrawer;
