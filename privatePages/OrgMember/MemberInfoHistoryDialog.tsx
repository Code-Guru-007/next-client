...
export const DIALOG = "MemberInfoHistoryDialog";
...
export interface MemberInfoHistoryDialogProps {
  targetId: string;
...
const MemberInfoHistoryDialog: FC<MemberInfoHistoryDialogProps> = function (
  props
) {
  ...
  const { data } = useOrgRecordTargets(
    {
      organizationId,
    },
    {
...
export default MemberInfoHistoryDialog;
