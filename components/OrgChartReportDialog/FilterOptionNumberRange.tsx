...
import StyledSlider from "@eGroupAI/material-lab/FilterDropDown/StyledSlider";
import { Value, ValueType } from "@eGroupAI/material-lab/FilterDropDown/types";
...
export type FilterOptionNumberRangeProps = NumberRangeSliderProps &
  NumberRangeInputProps;

const FilterOptionNumberRange = (props: FilterOptionNumberRangeProps) => {
  ...
  useEffect(() => {
    ...
    if (onChangeProp)
      onChangeProp([(from as number) || null, (to as number) || null]);
...
export default FilterOptionNumberRange;
