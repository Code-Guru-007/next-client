...
const DynamicColumnTemplateTableRow: FC<Props> = function (props) {
        ...
        <TableRow className={classes.tableRow} hover onClick={onClick}>
          <StyledDataTableCell>
            <StyledDataTableRowCheckbox
              dataId={`${row.organizationColumnTemplateId}`}
              data={row}
              size="small"
            />
          </StyledDataTableCell>
          <StyledDataTableCell>
            <Typography variant="body1">
              {row.organizationColumnTemplateTitle}
            </Typography>
          </StyledDataTableCell>
          <StyledDataTableCell>
            <Typography variant="body1">
              {format(
                zonedTimeToUtc(
                  row.organizationColumnTemplateCreateDate,
                  "Asia/Taipei"
                ),
                "PP pp",
                {
          ...
          <StyledDataTableCell>
            <Typography variant="body1">
              {format(
                zonedTimeToUtc(
                  row.organizationColumnTemplateUpdateDate,
                  "Asia/Taipei"
                ),
                "PP pp",
                {
...
export default DynamicColumnTemplateTableRow;
