...
export interface TaggedUserListProps {
  ...
  handleSelectTaggedName: (userToBeReplaced?: OrganizationMember) => void;
}
  ...
  return isOpen ? (
    <Stack
      sx={{
        ...
        zIndex: 10000,
        minWidth: 220,
        top: (openPosition?.top as number) + 14 + 14,
