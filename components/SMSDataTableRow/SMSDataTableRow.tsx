...
const SMSDataTableRow: FC<Props> = function (props) {
        ...
        <TableRow className={classes.tableRow} onClick={handleClick} hover>
          <StyledDataTableCell>
            <StyledDataTableRowCheckbox
              ...
              dataId={`${row.organizationSmsTemplateId}`}
              data={row}
              size="small"
            />
          </StyledDataTableCell>
          ...
          <StyledDataTableCell>
            <Typography variant="body1">
              {row.organizationSmsTemplateTitle}
            </Typography>
          </StyledDataTableCell>

          <StyledDataTableCell>
            <Typography variant="body1">
              {row.organizationSmsTemplateContent}
            </Typography>
          </StyledDataTableCell>

          <StyledDataTableCell>
            <Typography variant="body1">
              {row.organizationSmsTemplateCreateDate &&
                format(
                  zonedTimeToUtc(
                    new Date(row.organizationSmsTemplateCreateDate),
                    "Asia/Taipei"
                  ),
                  "PP pp",
                  { locale: zhCN }
          ...
          <StyledDataTableCell>
            <Typography variant="body1">
              {row.organizationSmsTemplateUpdateDate &&
                format(
                  zonedTimeToUtc(
                    new Date(row.organizationSmsTemplateUpdateDate),
                    "Asia/Taipei"
                  ),
                  "PP pp",
                  { locale: zhCN }
...
export default SMSDataTableRow;
