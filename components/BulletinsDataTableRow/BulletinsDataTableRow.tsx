...
const BulletinsDataTableRow: FC<Props> = function (props) {
    ...
    <>
      {!isDownSm && (
        <TableRow
          ...
          onClick={handleClick}
          hover
          id={`bulletin-row-${row.bulletinId}`}
          data-tid={`bulletin-row-${row.bulletinId}`}
        >
          <StyledDataTableCell>
          ...
          <StyledDataTableCell>
            <Typography variant="body1">
              {row.bulletinCreateDate &&
                format(
                  zonedTimeToUtc(
                    new Date(row.bulletinCreateDate),
                    "Asia/Taipei"
                  ),
                  "PP pp",
                  { locale: zhCN }
          ...
          <StyledDataTableCell>
            <Typography variant="body1">
              {row.bulletinUpdateDate &&
                format(
                  zonedTimeToUtc(
                    new Date(row.bulletinUpdateDate),
                    "Asia/Taipei"
                  ),
                  "PP pp",
                  { locale: zhCN }
          ...
          <StyledDataTableCell>
            <Typography variant="body1">{row?.creatorName}</Typography>
          </StyledDataTableCell>
        </TableRow>
      )}
      {isDownSm && (
...
export default BulletinsDataTableRow;
