...
import ProductFeatureListForm, { FORM } from "./ProductFeatureListForm";
...
const ProductFeatureListEditor: FC<CmsContentEditorProps> = function (props) {
  ...
  return (
    <>
      ...
      {/* <Grid container spacing={4}>
        {data?.organizationMediaList?.map((el) => (
          <Grid key={el.organizationMediaId} item xs={12} sm={12} md={4}>
            <FeatureCard
...
export default ProductFeatureListEditor;
