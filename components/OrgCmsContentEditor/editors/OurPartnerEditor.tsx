...
interface Data {
  ...
  organizationMediaLinkURL: string | undefined;
...
const OurPartnerEditor: FC<CmsContentEditorProps> = function (props) {
  const {
    data,
    onEditClose,
    primary,
                ...
                {visibleRows?.map((row: any, index) => {
                  ...
                  return (
                    <TableRow
                      ...
                      tabIndex={-1}
                      key={row?.organizationMediaLinkURL}
...
export default OurPartnerEditor;
