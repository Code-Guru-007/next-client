...
import SustainableDevelopmentForm, { FORM } from "./SustainableDevelopmentForm";
...
const SustainableDevelopmentEditor: FC<CmsContentEditorProps> = function (
  props
) {
...
export default SustainableDevelopmentEditor;
