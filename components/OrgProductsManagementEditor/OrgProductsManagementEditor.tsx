...
import { Locale, PageType, ContentType } from "interfaces/utils";
...
export interface OrgProductsManagementEditorProps {
  pageType: PageType;
  title: string;
  targetId?: string;
...
const headCells = [
  ...
  {
    id: "organizationProductDescription",
    numeric: false,
    disablePadding: true,
    label: "描述",
  },
...
const OrgProductsManagementEditor: FC<OrgProductsManagementEditorProps> =
  function (props) {
    const {
      pageType,
      targetId,
    ...
    const { data, mutate, isValidating } = useOrgProducts(
      {
        organizationId,
      },
      {
                      ...
                      return (
                        ...
                        >
                          ...
                          >
                            ...
                            <TableCell>
                              {row?.organizationProductDescription}
                            </TableCell>
                            <TableCell align="right">
                              {moment(
                                row?.organizationProductCreateDate
                              ).format("ll")}
                            </TableCell>
                          </TableRow>
                        </NextLink>
...
export default OrgProductsManagementEditor;
