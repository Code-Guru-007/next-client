      ...
      >
          ...
          {activeStep === 0 && (
            <Box sx={{ mt: 3 }}>
              <TextField
                ...
                required
                placeholder={
                  wordLibrary?.["Please enter SMS subject"] ?? "請輸入簡訊主題"
                }
                sx={{ mb: 3 }}
        ...
        <DialogActions>
          ...
          {activeStep !== 0 && !loading && (
            <DialogConfirmButton onClick={handlePrev} rounded>
