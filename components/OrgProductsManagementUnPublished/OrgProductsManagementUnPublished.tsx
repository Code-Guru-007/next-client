...
export interface OrgProductsUnPublishProps {
  pageType: PageType;
  title: string;
  targetId?: string;
...
const OrgProductsManagementUnPublished: FC<OrgProductsUnPublishProps> =
  function (props) {
    const {
      targetId,
      openAddDialog,
    ...
    const { data, isValidating, mutate } = useOrgProducts(
      ...
      {
        organizationProductIsVisible: 0,
...
export default OrgProductsManagementUnPublished;
