...
describe("objectCheckNull", () => {
  it("should check if object key with null or undefined value(Shallow).", () => {
    ...
    expect(
      objectCheckNull(obj, { checkEmptyString: true, checkFalse: true })
    ).toBe(true);
    expect(
      objectCheckNull(obj, { checkEmptyString: true, checkZero: true })
    ).toBe(true);
    expect(
      objectCheckNull(obj, {
    ...
    expect(objectCheckNull(obj, { checkFalse: true, checkZero: true })).toBe(
      true
    );
    ...
    expect(
      objectCheckNull(obj2, { checkEmptyString: true, checkFalse: true })
    ).toBe(false);
    expect(
      objectCheckNull(obj2, { checkEmptyString: true, checkZero: true })
    ).toBe(false);
    expect(
      objectCheckNull(obj2, {
        checkEmptyString: true,
        checkFalse: true,
        checkZero: true,
      })
    ...
    expect(objectCheckNull(obj2, { checkFalse: true, checkZero: true })).toBe(
      false
    );
  ...
  it("should check if object key with false value(Shallow).", () => {
    ...
    expect(objectCheckNull(obj, { checkFalse: true })).toBe(true);
    expect(
      objectCheckNull(obj, { checkFalse: true, checkEmptyString: true })
    ).toBe(true);
    expect(
      objectCheckNull(obj, {
        checkFalse: true,
    ...
    expect(
      objectCheckNull(obj2, { checkFalse: true, checkEmptyString: true })
    ).toBe(true);
    expect(
      objectCheckNull(obj2, {
        checkFalse: true,
  ...
  it("should check if object key with 0 value(Shallow).", () => {
    ...
    expect(objectCheckNull(obj, { checkZero: true })).toBe(true);
    expect(
      objectCheckNull(obj, { checkZero: true, checkEmptyString: true })
    ).toBe(true);
    expect(
      objectCheckNull(obj, {
        checkZero: true,
    ...
    expect(
      objectCheckNull(obj2, { checkZero: true, checkEmptyString: true })
    ).toBe(true);
    expect(
      objectCheckNull(obj2, {
        checkZero: true,
