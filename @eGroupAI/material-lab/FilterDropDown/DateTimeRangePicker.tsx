...
const DateTimeRangePicker: FC<NewDateRangePickerProps> = (props) => {
  const { name, setFilterOptionsTempValue, ...others } = props;
  ...
  const handleChange = useCallback(
    ...
    [others.showTime, setFilterOptionsTempValue, name]
  );
